...
@Repository
public interface Sensor9in1Repository extends JpaRepository<Sensor9in1, Integer> {
     ...
     */
    List<Sensor9in1> findByRoom_Id(Long roomId);

    /**
     * Trouver par nom personnalisé exact
     */
    List<Sensor9in1> findByCustomName(String customName);

    /**
     * Trouver un objet par son ID (read standard)
     */
    Optional<Sensor9in1> findById(Integer id);

    /**
     * Créer ou mettre à jour un objet (save standard)
     */
    @Override
    <S extends Sensor9in1> S save(S entity);

    /**
     * Créer ou mettre à jour une liste d’objets
     */
    @Override
    <S extends Sensor9in1> List<S> saveAll(Iterable<S> entities);
     ...
     */
    @Override
    void deleteAll(Iterable<? extends Sensor9in1> entities);
